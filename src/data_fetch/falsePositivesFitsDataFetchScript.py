...
for toi_id in remaining_toi_ids:
    ...
    try:
        for _, row in toi_df.iterrows():
            ...
            if '_lc.fits' in file_url and file_counts['LC'] < 5:
                file_type, save_dir = 'LC', lc_dir
            elif '_llc.fits' in file_url and file_counts['LLC'] < 5:
                file_type, save_dir = 'LLC', llc_dir
