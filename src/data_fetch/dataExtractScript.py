...
output_file = 'data/matched_observations_lc_data.csv'
...
for tic_id in tic_ids[4378:]:
    ...
    try:
        ...
        if len(tic_catalog_data) > 0:
            ...
            obs_df.to_csv(f'data/observationsData/observations_table_{tic_id}.csv', index=False)
